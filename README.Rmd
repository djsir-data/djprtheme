...
col_names <- c("djpr_blue",
          "djpr_bondi_blue",
          "djpr_cobalt",
          "djpr_cool_grey_1",
          "djpr_cool_grey_11",
          "djpr_dark_pastel_green",
          "djpr_electric_lime",
          "djpr_golden_yellow",
          "djpr_green",
          "djpr_iris_blue",
...
You can style your plots with the DJPR palette using the `djpr_colour_manual()` and `djpr_fill_manual()` functions. You should specify the number of colours in your plot.
